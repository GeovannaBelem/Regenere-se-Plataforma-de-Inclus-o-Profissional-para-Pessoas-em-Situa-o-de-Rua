...
if(isset($_POST['subExcluir'])){
    include_once('config.php');
    $atualizar = $conexao->prepare("DELETE FROM cadastroempresa  WHERE cnpj= '$cnpj'");
    $atualizar->execute();
...
if (isset($_POST['sub'])) {
    ...
    header('Location:PerfilUsuarioEmpresa.php');
...
<body>
    ...
    <div id="geral">
        <div id="geral1">
            ...
            <form action="PerfilUsuarioEmpresa.php" method="POST">
        ...
        <div id="geral2">
            <div id="escolha">
                <div id="btn_filtro">
                    <button id="btn_pess" onclick="mostrar_linha1()">Empresa</button>
                    <button id="btn_pess" onclick="mostrar_linha2()">Dados Gerais</button>
                </div>
                <div id="linha_filtro">
        ...
        <form action="PerfilUsuarioEmpresa.php" method="POST" id="Editar">
            <div id="btn_filtro">
